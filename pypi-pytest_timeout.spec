...
Source0  : https://files.pythonhosted.org/packages/2a/b0/8e3182e9ed65ad5b247f9d13769f214fc52b0d3522c3e1c8dbfa2f879e5a/pytest-timeout-2.2.0.tar.gz
...
%prep
%setup -q -n pytest-timeout-2.2.0
cd %{_builddir}/pytest-timeout-2.2.0
pushd ..
cp -a pytest-timeout-2.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1696864476
