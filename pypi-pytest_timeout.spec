...
Provides: pytest-timeout
Provides: pytest-timeout-python
Provides: pytest-timeout-python3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641482404
...
cp %{_builddir}/pytest-timeout-2.0.2/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pytest_timeout/8216f3d66db8d3c8edf0e6c29f7db60c021f3490
